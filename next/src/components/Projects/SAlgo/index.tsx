...
const SAlgo = () => {
  ...
  const [arrayInView, setArrayInView] = useState([]);
  ...
  const handleInputTextFieldArraySize = () => {
    if (
      (textArraySizeInputField.current?.value ??
        Number(arrayInViewVars.width)) > Number(arrayInViewVars.width * 0.95)
    ) {
      return;
    }
      ...
      <div className={styles.main}>
        ...
        <div className={styles.alg_master}>
          <div className={styles.nav}>
            ...
            <div className={styles.nav_section}>
              ...
              <div>
                ...
                />
                <div className={styles.out_of_bounds}>
          ...
          <div className={styles.alg_bottom}>
            ...
            <div className={styles.alg_explanation}>
              {selAlg.title == '-1' ? (
