import styles from '@s/disclaimer/main.module.scss';
      ...
      <div className={styles.wrapper}>
        <div className={text_styles.text}>
          <div className={styles.main}>
            <h1 className={text_styles.title}>Disclaimer</h1>
            <p>Last updated: April 09, 2023</p>
            <h1 className={text_styles.subtitle}>
            ...
            <ul>
              <li>
                ...
                in this Disclaimer) refers to Magnus Zoeschinger&apos;s website.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Magnus Zoeschinger&apos;s
                website, accessible from{' '}
                <Link
                  href='https://www.zoeschinger.com/'
                  target='_blank'
            ...
            <h1 className={text_styles.subtitle}>Disclaimer</h1>
            <p>
            ...
            <h1 className={text_styles.subtitle}>External Links Disclaimer</h1>
            <p>
            ...
            <h1 className={text_styles.subtitle}>Fair Use Disclaimer</h1>
            <p>
            ...
            <h1 className={text_styles.subtitle}>Views Expressed Disclaimer</h1>
            <p>
            ...
            <h1 className={text_styles.subtitle}>Contact Us</h1>
            <p>
            ...
            <ul>
              <li>
                <p>By email: [currently not available]</p>
              </li>
              <li>
                <p>
